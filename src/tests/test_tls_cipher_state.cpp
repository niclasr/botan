...
std::vector<Test::Result> test_state_machine()
   {
   return
      {
...
BOTAN_REGISTER_TEST_FN("tls", "tls_cipher_state", test_state_machine, test_secret_derivation_rfc8448_rtt1);
}
